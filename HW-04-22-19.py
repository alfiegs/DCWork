...
# word_histogram = {}
# paragraph = "To be or not to be, that is the question. Whether tis nobler in the mind to suffer the slings and arrows of outrageous fortunes..."
# paragraph = paragraph.lower()
# paragraph = paragraph.split()
